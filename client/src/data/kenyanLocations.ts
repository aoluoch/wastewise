...
export const KENYAN_COUNTIES: County[] = [
  ...
  },
  {
    name: 'Nakuru',
    constituencies: [
      'Nakuru Town East', 'Nakuru Town West', 'Bahati', 'Gilgil', 'Kuresoi North',
      'Kuresoi South', 'Molo', 'Njoro', 'Naivasha', 'Rongai', 'Subukia'
    ]
  },
  {
    name: 'Kiambu',
  ...
  },
  {
    name: 'Machakos',
    constituencies: [
      'Machakos Town', 'Mavoko', 'Kathiani', 'Yatta', 'Kangundo',
      'Matungulu', 'Mwala', 'Masinga'
    ]
  },
  {
    name: 'Kajiado',
  ...
  },
  {
    name: 'Kakamega',
    constituencies: [
      'Butere', 'Mumias West', 'Mumias East', 'Matungu', 'Khwisero',
      'Shinyalu', 'Lurambi', 'Ikolomani', 'Lugari', 'Malava', 'Kabondo', 'Navakholo'
    ]
  },
  {
    name: 'Bungoma',
  ...
  },
  {
    name: 'Murang\'a',
    constituencies: [
      'Kangema', 'Mathioya', 'Kiharu', 'Kigumo', 'Maragwa',
      'Kandara', 'Gatanga'
    ]
  },
  {
  ...
  },
  {
    name: 'Kericho',
    constituencies: [
      'Ainamoi', 'Bureti', 'Belgut', 'Sigowet/Soin', 'Kipkelion East', 'Kipkelion West'
    ]
  },
  {
    name: 'Bomet',
  ...
  },
  {
    name: 'Narok',
    constituencies: [
      'Narok North', 'Narok East', 'Narok South', 'Narok West',
  ...
  },
  {
    name: 'Baringo',
    constituencies: [
      'Baringo North', 'Baringo Central', 'Baringo South',
      'Mogotio', 'Eldama Ravine', 'Tiaty'
    ]
  },
  {
    name: 'Laikipia',
  ...
  },
  {
    name: 'West Pokot',
    constituencies: [
      'Kacheliba', 'Kapenguria', 'Sigor', 'Pokot South'
    ]
  },
  {
