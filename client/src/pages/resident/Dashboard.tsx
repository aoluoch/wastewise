            ...
            <div className='flex items-start'>
              ...
              <div className='ml-3 flex-1'>
                ...
                <p className='mt-2 text-sm text-green-700 dark:text-green-300'>
                  Congratulations! Your application to become a collector has
                  been approved. Please log out and log back in to access your
                  collector dashboard.
                </p>
              </div>
            </div>
          ...
          <div className='flex items-start'>
            ...
            <div className='ml-3 flex-1'>
              ...
              <p className='mt-2 text-sm text-red-700 dark:text-red-300'>
                Unfortunately, your collector application was not approved at
                this time. You can reapply using the form below.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='bg-white dark:bg-gray-800 rounded-lg shadow'>
          ...
          <div className='p-6'>
            {statsLoading ? (
              ...
              Array.isArray(stats.recentReports) &&
